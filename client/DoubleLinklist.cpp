...
void choose()
{
    ...
    DataType food4 = {"麻婆豆腐", "麻辣", 15, 0, 0, "./foodpicture/food4.bmp"};
    DataType food5 = {"番茄蛋汤", "浓香", 10, 0, 0, "./foodpicture/food5.bmp"};
    DataType food6 = {"酱汁秋葵", "爽脆", 17, 1, 0, "./foodpicture/food6.bmp"};
...
void *list_start(void *arg)
{
    ...
    DataType food4 = {"麻婆豆腐", "麻辣", 15, 0, 0, "./foodpicture/food4.bmp"};
    DataType food5 = {"番茄蛋汤", "浓香", 10, 0, 0, "./foodpicture/food5.bmp"};
    DataType food6 = {"酱汁秋葵", "爽脆", 17, 0, 1, "./foodpicture/food6.bmp"};
    DataType food7 = {"回锅肉", "咸鲜", 18, 0, 0, "./foodpicture/food1.bmp"};
    DataType food8 = {"狮子头", "鲜香", 20, 0, 0, "./foodpicture/food2.bmp"};
    DataType food9 = {"蒸水蛋", "爽滑", 12, 0, 0, "./foodpicture/food3.bmp"};
    list.Insert(food1, 1);
    list.Insert(food2, 2);
    list.Insert(food3, 3);
    list.Insert(food4, 4);
